  ...
  <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm ">
    <div class="flex items-start justify-between gap-3">
      <div>
        ...
        <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-gray-50">{{ value }}</p>
        ...
        <div v-if="typeof delta === 'number'" class="mt-2 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs"
             :class="delta >= 0 ? 'bg-green-50 text-green-700 dark:bg-green-500/10 dark:text-green-300'
