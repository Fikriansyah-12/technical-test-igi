    ...
    <div class="grid gap-4 lg:grid-cols-3">
      <div class="lg:col-span-2">
        <SectionCard>
          ...
          <BarChart :labels="labelsDays" :values="seriesRevenue" :height="180">
            <template #title><h3 class="text-sm font-medium">Pendapatan 7 Hari</h3></template>
          </BarChart>
        </SectionCard>
      </div>
      <div>
        <SectionCard>
          ...
          <div class="pt-2 text-blue-600 bg-white ">
            <Sparkline :data="seriesOrders" :width="360" :height="120" />
          </div>
        </SectionCard>
      </div>
    </div>
